...
### CHANGE 3: ufw enabling for tailscale.
 ...
 Future updates to app will include installing TAILSCALE to allow users to access their samba share drives remotely. I understand it's advisable to have ufw enabled and have samba and/or tailscale authorized or enable by ufw.  Devise a plan to include a new step in the process to activate ufw with the user.  If having tailscale installed first is a safer order of operations.... plan the best implimentation with these factors in mind.
